...
import sys
sys.path.append("/home/ubuntu/project/nerf/nerfstudio/")
...
def colmap_to_json(
    ...
    for im_id, im_data in im_id_to_image.items():
        ...
        cam_params = parse_colmap_camera_params(cam_id_to_camera[im_data.camera_id])
        frame.update(cam_params)
        frames.append(frame)
...
input=Path(r"/home/ubuntu/project/nerf/nerfstudio/data/nuscenesfront/sparse/0")
output=Path(r"/home/ubuntu/project/nerf/nerfstudio/data/nuscenesfront")
colmap_to_json(input,output)
