...
with open('/home/ubuntu/project/nerf/nerfstudio/data/yr/case1/transforms.json', 'r') as f:
    data = json.load(f)
...
for frame in data['frames']:
    ...
    value = "segs"
    # 添加 "v" 字段，并赋值为提取的字符串
    frame['seg_path'] =  file_path.replace('images', value)
    #frame['mask_path'] =  "/home/ubuntu/project/nerf/nerfstudio/data/baixiniu/leftfront/masks_2/1111.png"
    # 替换 images 为提取的字符串


# 保存修改后的数据到新的文件
with open('/home/ubuntu/project/nerf/nerfstudio/data/yr/case1/transforms.json', 'w') as f:
